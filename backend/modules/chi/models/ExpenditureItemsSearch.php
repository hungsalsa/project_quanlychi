...
/**
 * ExpenditureItemsSearch represents the model behind the search form of `backend\modules\chi\models\ExpenditureItems`.
 */
class ExpenditureItemsSearch extends ExpenditureItems
{
    /**
     * @inheritdoc
     */
