...
class DoanhThuSearch extends DoanhThu
{
    ...
    {
        return [
            [['id', 'giao_sang', 'tt_ck', 'tt_the', 'tt_tien_mat', 'tong_doanh_thu_phieu', 'doanh_thu_thuc', 'thu_khac', 'tien_chi', 'tien_hom', 'tien_le', 'chenh_lech', 'ketoan', 'nguoi_ky', 'cua_hang', 'created_at', 'updated_at', 'user_add'], 'integer'],
            [['ngay', 'note', 'status'], 'safe'],
        ];
    }
